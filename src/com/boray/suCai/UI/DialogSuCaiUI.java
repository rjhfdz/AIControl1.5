...
public class DialogSuCaiUI {
    ...
    private void setP1(JScrollPane scrollPane) {
        ...
        final JList list = new JList();
        DefaultListModel model = new DefaultListModel();
        String str = HttpClientUtil.doGet(Data.ipPort + "/getku?username=" + users.getUsername());
        ...
        list.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent listSelectionEvent) {
                if (list.getSelectedValue() != null) {
                    ...
                    String str = HttpClientUtil.doGet(Data.ipPort + "/getsctype?username=zhenglinq_wirg&kuname=" + list.getSelectedValue().toString() + "");
