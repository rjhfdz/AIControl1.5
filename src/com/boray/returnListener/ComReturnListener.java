...
public class ComReturnListener implements Runnable{
		...
		try {
			...
			while (true) {
				...
				if (len > 5) {
					...
					} */else if (hex0.equals("fd") && hex1.equals("64")) {
	...
	private void setTiaoGuang_1(byte[] b,int cj ,String s){
		...
		if (cj == 25) {//可调、下限
			...
			box.addItemListener(listener);box2.addItemListener(listener2);
			box3.addItemListener(listener3);box4.addItemListener(listener4);
