...
public class GuangLiUI implements ActionListener{
	...
	public void show(JPanel pane){
		...
		headPane.add(exportBtn);headPane.add(importBtn);
	...
	private void setLastPane(JPanel pane){
		...
		for (int i = 0; i < 3; i++) {
			...
			boxs7[i].addItem("正向");boxs7[i].addItem("反向");
