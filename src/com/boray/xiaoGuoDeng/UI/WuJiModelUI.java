...
public class WuJiModelUI {
	...
	private void setStartPane(JPanel pane){
		...
		p2.add(slider);p2.add(field);p2.add(new JLabel("毫秒"));
		////////////////////////执行时长
	...
	private void setHeadPane(JPanel pane) {
		...
		pane.add(new JLabel("            DMX512地址:"));pane.add(box88);
		pane.add(new JLabel("                       "));
		...
		pane.add(radioButton3);pane.add(radioButton4);
		pane.add(new JLabel("                 通道数量:"));pane.add(box2);
		if (tkp != null) {
