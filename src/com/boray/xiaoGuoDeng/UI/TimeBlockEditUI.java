...
public class TimeBlockEditUI {
	...
	public void show(int block,String groupNum){
		dialog = new JDialog();
		...
		timeBlockReviewActionListener = new TimeBlockReviewActionListener(XiaoGuoDengModel.model,group_N,blockNum);
...
//		}
	...
	private void setChannelPane(JPanel pane) {
		...
		button.addActionListener(actionListener);button2.addActionListener(actionListener);
		FlowLayout flowLayout = new FlowLayout(FlowLayout.LEFT);
		flowLayout.setVgap(-2);
		p1.setLayout(flowLayout);
		p1.add(button);p1.add(button2);
		...
		box2 = new JComboBox();
		box2.addItem("不拆分");box2.addItem("中间拆分");box2.addItem("两端拆分");
		p3.add(box2);
		...
		FlowLayout flowLayout2 = new FlowLayout(FlowLayout.LEFT);
		flowLayout2.setVgap(-2);flowLayout2.setHgap(0);
	...
	private void setRgbColor3(JPanel pane) {
		...
		group2.add(radioButton);group2.add(radioButton2);
		...
		p1.add(radioButton);p1.add(new JLabel("   "));p1.add(radioButton2);
		p1.add(new JLabel("           "));
		p1.add(button);p1.add(new JLabel("   "));p1.add(button2);
		...
		p2.add(new JLabel("R "));
		p2.add(slider);p2.add(field);
		p2.add(new JLabel("G "));
		p2.add(slider2);p2.add(field2);
		p2.add(new JLabel("B "));
		p2.add(slider3);p2.add(field3);
		...
		rgb1CompontList3.add(checkBox);rgb1CompontList3.add(checkBox2);
		rgb1CompontList3.add(checkBox3);
		p3.add(checkBox);p3.add(new JLabel("  "));p3.add(checkBox2);
		p3.add(new JLabel("  "));p3.add(checkBox3);
		...
		p4.add(checkBox4);p4.add(button3);
		...
		group.add(box2);group.add(box3);
		p4.add(box2);p4.add(box3);
		...
		p5.add(new JLabel("渐变速度"));p5.add(slider4);p5.add(field4);
		...
		box4.addItem("不拆分");box4.addItem("中间拆分");box4.addItem("两端拆分");
		JCheckBox checkBox5 = new JCheckBox("拆分反向");
		rgb1CompontList3.add(checkBox5);
		panel.add(box4);panel.add(checkBox5);
		...
		panel.add(slider5);panel.add(field5);
		p6.add(panel);
	...
	private void setRgbColor2(JPanel pane) {
		...
		JCheckBox checkBox2 = new JCheckBox("G");
		JCheckBox checkBox3 = new JCheckBox("B");
		rgb1CompontList2.add(checkBox);rgb1CompontList2.add(checkBox2);
	...
	private void setRgbColor1(JPanel pane) {
		...
		JCheckBox checkBox2 = new JCheckBox("G");
		JCheckBox checkBox3 = new JCheckBox("B");
		rgb1CompontList.add(checkBox);rgb1CompontList.add(checkBox2);
	...
	private void setDonZuoPane(JPanel pane) {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ButtonGroup group = new ButtonGroup();
				group.add(radioButton);group.add(radioButton2);
				dialog2.add(radioButton);dialog2.add(radioButton2);
				JPanel p1 = new JPanel();
				FlowLayout flowLayout2 = new FlowLayout(FlowLayout.LEFT);
				...
				dialog2.add(p1);
				p1.add(new JLabel("                X"));p1.add(new JLabel("                  Y"));
				p1.add(new JLabel("      "));
				p1.add(new JLabel("     1:"));
				...
				dialog2.add(button);dialog2.add(new JLabel("   "));dialog2.add(button2);
				dialog2.setVisible(true);
			}
		});
		JButton button2 = new JButton("动作图形");
		p2.add(button);p2.add(button2);
		...
		p4_to_p2.add(box3);p4_to_p2.add(box4);
		p4_to_p2.add(new JLabel("       "));
		p4_to_p2.add(box5);p4_to_p2.add(box6);
	...
	private void outDevice(){
		...
		if (Data.serialPort != null && slt.length != 0) {
			try {
				...
				buff[0] = (byte)0xBB;buff[1] = (byte)0x55;
				buff[2] = (byte)(520/256);buff[3] = (byte)(520%256);
				buff[4] = (byte)0x80;buff[5] = (byte)0x01;
				buff[6] = (byte)0xFF;
