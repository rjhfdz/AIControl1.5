...
public class TimeBlockReviewData {
	...
	public static byte[] getInfOfLight(){
		...
		lightsByte[0] = (byte)0xBB;lightsByte[1] = (byte)0x55;
		lightsByte[2] = (byte)(length/256);lightsByte[3] = (byte)(length%256);
		lightsByte[4] = (byte)0x81;lightsByte[5] = (byte)0x01;
	...
	public static byte[] getGroupOfLights(){
		...
		temp[0] = (byte)0xBB;temp[1] = (byte)0x55;
		temp[2] = (byte)((size+9)/256);temp[3] = (byte)((size+9)%256);
		temp[4] = (byte)0x82;temp[5] = (byte)0x01;
	...
	public static byte[][] getlibOfLights(){
		...
		for (int i = 0; i < 2; i++) {
			temp[i][0] = (byte)0xBB;temp[i][1] = (byte)0x55;
			temp[i][2] = (byte)(340/256);temp[i][3] = (byte)(340%256);
			temp[i][4] = (byte)0x84;temp[i][5] = (byte)0x01;
			temp[i][6] = (byte)(i+1);
		}
	...
	public static byte[][] getOffLights(){
		...
		for (int i = 0; i < 2; i++) {
			temp[i][0] = (byte)0xBB;temp[i][1] = (byte)0x55;
			temp[i][2] = (byte)(338/256);temp[i][3] = (byte)(338%256);
			temp[i][4] = (byte)0x83;temp[i][5] = (byte)0x01;
			temp[i][6] = (byte)(i+1);
		}
		//灯库
		NewJTable table = (NewJTable)MainUi.map.get("table_DkGl");
	...
	public static byte[] getStopReview(int sc,int group,int block){
		...
		temp[0] = (byte)0xBB;temp[1] = (byte)0x55;
		temp[2] = (byte)((15)/256);temp[3] = (byte)((15)%256);
		temp[4] = (byte)0x86;temp[5] = (byte)0x01;
		temp[6] = (byte)0xF0;
		temp[7] = (byte)sc;
		temp[8] = (byte)group;
		temp[9] = (byte)block;
	...
	public static Object[] getEffectLight(int sc,int group,int block){
		byte[] b = getEffectLightToOne(sc,group,block);
		...
		for (int i = 0; i < packet; i++) {
			if (i != (packet-1)) {
				...
				tp1[0] = (byte)0xBB;tp1[1] = (byte)0x55;
				tp1[2] = (byte)(521/256);tp1[3] = (byte)(521%256);
				tp1[4] = (byte)0x85;tp1[5] = (byte)0x11;
				tp1[6] = (byte)((i+1)/256);tp1[7] = (byte)((i+1)%256);
				System.arraycopy(b, 8+i*512, tp1, 8, 512);
				tp1[520] = ZhiLingJi.getJiaoYan(tp1);
				temp[i] = tp1;
			} else {
				byte[] tp2 = new byte[lastSize+9];
				tp2[0] = (byte)0xBB;tp2[1] = (byte)0x55;
				tp2[2] = (byte)((lastSize+9)/256);tp2[3] = (byte)((lastSize+9)%256);
				tp2[4] = (byte)0x85;tp2[5] = (byte)0x11;
				tp2[6] = (byte)((i+1)/256);tp2[7] = (byte)((i+1)%256);
	...
	public static byte[] getEffectLightToOne(int sc,int group,int block){
		...
		temp[0] = (byte)0xBB;temp[1] = (byte)0x55;
		temp[2] = (byte)(length/256);temp[3] = (byte)(length%256);
		temp[4] = (byte)0x85;temp[5] = (byte)0x11;
		temp[6] = (byte)0x00;temp[7] = (byte)0x01;
		...
		DefineJLable lable = (DefineJLable)timeBlockPanels[group+1].getComponent(block);
