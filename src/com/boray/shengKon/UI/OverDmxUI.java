...
public class OverDmxUI implements ActionListener{
		...
		dialog.addWindowListener(new WindowAdapter() {
			public void windowClosed(WindowEvent e) {
				if (runTable.getRowCount() > 0) {
					...
					Data.ShengKonModelDmxMap.put("TableData"+MyData.ShengKonModel+setNo, temp);
				} else {
					Data.ShengKonModelDmxMap.put("TableData"+MyData.ShengKonModel+setNo, null);
				}
				boolean[] tbs = bs.clone();
				Data.ShengKonModelDmxMap.put("GouXuanValue"+MyData.ShengKonModel+setNo, tbs);
				...
				Data.ShengKonModelDmxMap.put("YaoMaiSet"+MyData.ShengKonModel+setNo, s);
			}
		});
	...
	void setP1(JPanel pane){
		...
		flowLayout.setVgap(-2);flowLayout.setHgap(0);
	...
	void setP2(JPanel pane){
		...
		String[] setValue = (String[])Data.ShengKonModelDmxMap.get("YaoMaiSet"+MyData.ShengKonModel+setNo);
		if (setValue != null) {
	...
	void setP4(JPanel pane){
		...
		pane.add(slider);pane.add(field);pane.add(new JLabel("毫秒"));
	}
	void setP5(JPanel pane){
		...
		Vector vector99 = (Vector)Data.ShengKonModelDmxMap.get("TableData"+MyData.ShengKonModel+setNo);;
		if (vector99!=null) {
			Vector tp = null;
			int a = 0;
	...
	private void setHeader(){
		...
		if (Data.ShengKonModelDmxMap.get("GouXuanValue"+MyData.ShengKonModel+setNo)!=null) {
			bs = (boolean[])Data.ShengKonModelDmxMap.get("GouXuanValue"+MyData.ShengKonModel+setNo);
		}
	...
	void setP6(JPanel pane){
		...
		p4.add(slider);p4.add(field);p4.add(new JLabel("毫秒"));
