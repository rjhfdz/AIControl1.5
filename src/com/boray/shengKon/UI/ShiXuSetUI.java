...
public class ShiXuSetUI {
	...
	public void show(int blockNum){
		...
		p1.setBorder(tb);p2.setBorder(tb1);p3.setBorder(tb);p4.setBorder(tb1);p5.setBorder(tb2);p6.setBorder(tb3);
		p1.setPreferredSize(new Dimension(610,84));p2.setPreferredSize(new Dimension(400,84));
		p3.setPreferredSize(new Dimension(610,322));p4.setPreferredSize(new Dimension(400,322));
		p5.setPreferredSize(new Dimension(610,258));p6.setPreferredSize(new Dimension(400,258));
		setP1(p1);setP2(p2);setP3(p3);
		setP4(p4);setP5(p5);setP6(p6);
		
		dialog.add(p1);dialog.add(p2);dialog.add(p3);
		dialog.add(p4);dialog.add(p5);dialog.add(p6);
	...
	void setP1(JPanel pane){
		...
		box.addItem("硬切");box.addItem("渐变");
		p1.add(box);
		final JLabel label = new JLabel("渐变速度:");
		final JComboBox box2 = new JComboBox();
		box2.addItem("特慢");box2.addItem("慢");box2.addItem("普快");box2.addItem("快");box2.addItem("特快");
		...
		box3.addItem("硬切");box3.addItem("渐变");box3.addItem("心跳");
		pane.add(box3);
		final JLabel label2 = new JLabel("渐变速度:");
		final JComboBox box4 = new JComboBox();
		box4.addItem("特慢");box4.addItem("慢");box4.addItem("普快");box4.addItem("快");box4.addItem("特快");
		pane.add(label2);pane.add(box4);
	...
	void setP5(JPanel pane){
		...
		final JComboBox box3 = new JComboBox();
		box3.addItem("硬切");box3.addItem("渐变");
		p2.add(box3);
		final JLabel label2 = new JLabel("渐变速度:");
		final JComboBox box4 = new JComboBox();
		box4.addItem("特慢");box4.addItem("慢");box4.addItem("普快");box4.addItem("快");box4.addItem("特快");
		p2.add(label2);p2.add(box4);
		label2.setVisible(false);
		box4.setVisible(false);
