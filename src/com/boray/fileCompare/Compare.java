...
public class Compare {
    ...
    private byte[] getCC(int select) {
        ...
        if (map2 == null) {
            ...
            for (int i = 0; i < 4; i++) {
                if (blackOutEntity.getC(i)[0].equals("所有") || blackOutEntity.getC(i)[0] == "所有") {
                    cc[8 + i * 4] = (byte) 0xFF;
                } else if (blackOutEntity.getC(i)[0].equals("无") || blackOutEntity.getC(i)[0] == "无") {
                    cc[8 + i * 4] = 0;
                } else {
            ...
            for (int i = 0; i < 3; i++) {
                if (speedEntity.getS(i)[0].equals("无") || speedEntity.getS(i)[0] == "无") {
                    cc[28 + i * 4] = (byte) 0;
                } else {
                ...
                if (speedEntity.getS(i)[3].equals("正向") || speedEntity.getS(i)[3] == "正向") {
                    cc[31 + i * 4] = (byte) 0;
                } else {
                    cc[31 + i * 4] = (byte) 1;
                }
