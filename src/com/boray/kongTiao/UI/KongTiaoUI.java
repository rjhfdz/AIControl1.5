...
public class KongTiaoUI implements ActionListener{
	...
	public void show(JPanel pane) {
		...
		setP1(p1);setP2(p2);setP3(p3);setP4(p4);
		pane.add(p1);pane.add(p2);pane.add(p3);//pane.add(p4);
	}
	...
	void setP2(JPanel allPane){
		...
		ButtonGroup group = new ButtonGroup();
		group.add(radioButton);group.add(radioButton2);
		p1.add(radioButton);p1.add(radioButton2);p1.add(new JLabel("                            "));
	...
	void setP3(JPanel allPane){
		...
		radioButton.addActionListener(this);radioButton2.addActionListener(this);
		...
		radioButton4.addActionListener(this);radioButton5.addActionListener(this);
		radioButton6.addActionListener(this);radioButton7.addActionListener(this);
		radioButton8.addActionListener(this);
		ButtonGroup group2 = new ButtonGroup();
		group2.add(radioButton4);group2.add(radioButton5);group2.add(radioButton6);
		group2.add(radioButton7);group2.add(radioButton8);
		p2.add(radioButton4);p2.add(radioButton5);p2.add(radioButton6);
		p2.add(radioButton7);p2.add(radioButton8);
		...
		radioButton9.addActionListener(this);radioButton10.addActionListener(this);
		ButtonGroup group3 = new ButtonGroup();
		group3.add(radioButton9);group3.add(radioButton10);
		pane2.add(radioButton9);pane2.add(radioButton10);
		
		list.add(radioButton);list.add(radioButton2);list.add(radioButton3);
		list.add(radioButton4);list.add(radioButton5);list.add(radioButton6);
		list.add(radioButton7);list.add(radioButton8);list.add(radioButton9);
		list.add(radioButton10);list.add(box);list.add(label);
