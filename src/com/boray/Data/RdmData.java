...
public class RdmData {
	...
	public static byte[] serch(){
		...
		b[0] = (byte)0xFA;b[1] = (byte)0x14;
		b[2] = (byte)0x60;b[3] = (byte)ZhiLingJi.TYPE;
		b[4] = (byte)0x11;b[5] = (byte)0x00;
		b[6] = (byte)0xF1;
		/*for (int i = 0; i < 6; i++) {
			b[6+i] = (byte)0xFF;
		}*/
	...
	public static byte[] serchCount(){
		...
		b[0] = (byte)0xFA;b[1] = (byte)0x0E;
		b[2] = (byte)0xCC;b[3] = (byte)ZhiLingJi.TYPE;
		b[4] = (byte)0x00;b[5] = (byte)0x40;
		for (int i = 0; i < 6; i++) {
			b[6+i] = (byte)0xFF;
		}
		b[13] = getJiaoYan(b);
	...
	public static byte[] serchType(byte[] tp,int serchType){
		...
		b[0] = (byte)0xFA;b[1] = (byte)0x0E;
		b[2] = (byte)0xCC;b[3] = (byte)ZhiLingJi.TYPE;
		b[4] = (byte)serchType;b[5] = (byte)0x20;
	...
	public static byte[] setType(byte[] tp,int setType,byte[] value){
		...
		b[0] = (byte)0xFA;b[1] = (byte)0x10;
		b[2] = (byte)0xCC;b[3] = (byte)ZhiLingJi.TYPE;
		b[4] = (byte)setType;b[5] = (byte)0x30;
		for (int i = 0; i < tp.length; i++) {
			b[6+i] = tp[i];
		}
