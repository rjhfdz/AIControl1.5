...
public class ZhongKonUI {
	public void show(JPanel pane) {
		...
		p1.add(button);p1.add(new JLabel("                            "));
		//p1.setBorder(new LineBorder(Color.gray));
		...
		radioButton.addActionListener(listener3);radioButton2.addActionListener(listener3);
		list.add(radioButton);list.add(radioButton2);
		ButtonGroup group = new ButtonGroup();
		group.add(radioButton);group.add(radioButton2);
		p_p_p1.add(radioButton);p_p_p1.add(new JLabel("   "));p_p_p1.add(radioButton2);p_p_p1.add(new JLabel("            "));
		...
		radioButton3.addActionListener(listener3);radioButton4.addActionListener(listener3);
		list.add(radioButton3);list.add(radioButton4);
		ButtonGroup group2 = new ButtonGroup();
		group2.add(radioButton3);group2.add(radioButton4);
		p_p_p1.add(radioButton3);p_p_p1.add(new JLabel("      "));p_p_p1.add(radioButton4);p_p_p1.add(new JLabel("            "));
		...
		radioButton5.addActionListener(listener3);radioButton6.addActionListener(listener3);
		list.add(radioButton5);list.add(radioButton6);
		ButtonGroup group3 = new ButtonGroup();
		group3.add(radioButton5);group3.add(radioButton6);
		p_p_p1.add(radioButton5);p_p_p1.add(new JLabel("      "));p_p_p1.add(radioButton6);p_p_p1.add(new JLabel("            "));
		...
		radioButton7.addActionListener(listener3);radioButton8.addActionListener(listener3);
		list.add(radioButton7);list.add(radioButton8);
		ButtonGroup group4 = new ButtonGroup();
		group4.add(radioButton7);group4.add(radioButton8);
		JButton button2 = new JButton("多码设置");
		p_p_p1.add(radioButton7);p_p_p1.add(new JLabel("      "));p_p_p1.add(radioButton8);
		//p_p_p1.add(button2);
		...
		p_p_p2.add(box4);p_p_p2.add(new JLabel("(出厂默认为01)"));
