...
public class ProgramToTestListener implements ActionListener{
	public void actionPerformed(ActionEvent e) {
		...
		if ("场景编程".equals(radioButton.getText())) {
			setChangJing1(true);setChangJing2(true);
			p1.setVisible(false);
			Data.isTest = false;
			...
			setChangJing1(false);setChangJing2(false);
			p1.setVisible(true);
			Data.isTest = true;
		}
	}
