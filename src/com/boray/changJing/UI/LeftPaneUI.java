...
public class LeftPaneUI {
	public void show(JPanel pane){
		pane.setPreferredSize(new Dimension(410,550));
		...
		panel.setBorder(tb1);
		panel.setPreferredSize(new Dimension(410,460));
		...
		panel2.setPreferredSize(new Dimension(410,40));
