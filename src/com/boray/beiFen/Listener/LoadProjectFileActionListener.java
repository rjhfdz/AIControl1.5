...
public class LoadProjectFileActionListener implements ActionListener{
	...
	private void loadPjtUI(){
		...
		flowLayout.setVgap(40);flowLayout.setHgap(26);
		p1.setLayout(flowLayout);
		p1.add(radioButton);p1.add(new JLabel("     "));p1.add(radioButton2);//p1.add(radioButton3);
		...
		p1.add(sureBtn);p1.add(new JLabel(" "));p1.add(canceBtn);
		dialog.add(p1);
