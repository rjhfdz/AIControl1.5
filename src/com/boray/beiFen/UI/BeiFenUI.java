...
public class BeiFenUI {
    public void show(JPanel pane) {
        ...
        TitledBorder tb6 = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.gray), "写入控制器配置", TitledBorder.LEFT, TitledBorder.TOP, new Font(Font.SERIF, Font.BOLD, 12));
        np.setBorder(tb6);
...
//        button5.setPreferredSize(new Dimension(120, 34));
        ...
        MainUi.map.put("KonZhiQiCheckBox", checkBox);
